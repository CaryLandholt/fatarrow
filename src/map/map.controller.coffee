...
class Map extends Controller
	constructor: ($log) ->
		@center =
			lat: 25.76761284346764
			lng: -80.1356546046873
			zoom: 8
		...
		@markers =
			miami:
				...
				message: 'Miami'
				icon:
					iconUrl: 'http://icons.iconarchive.com/icons/yellowicon/game-stars/256/Mario-icon.png'
					iconSize: [40, 40]
